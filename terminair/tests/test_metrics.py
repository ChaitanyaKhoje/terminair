...
from terminair.metrics.error_extract import extract_error
from terminair.metrics.sparkline import compute_sparkline, render_pattern


@pytest.fixture
def sample_runs():
    from terminair.api.models import DagRun, DagRunState
